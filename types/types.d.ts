...
declare module 'datatables.net' {
    ...
    interface DataTablesStatic {
        ...
        ColumnControl: {
             ...
             */
            new (dt: Api<any>, columnIdx: number, config: ConfigColumnControl): DataTablesStatic['ColumnControl'];
            /**
    ...
    interface ApiColumnMethods<T> {
        ...
        columnControl: {
             ...
             */
            searchList(options: 'refresh' | string[] | Array<{
                label: string;
                value: any;
            }>): ApiColumnMethods<T>;
        };
